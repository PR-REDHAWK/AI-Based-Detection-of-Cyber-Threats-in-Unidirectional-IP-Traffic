...
class DDoSDetector(BaseDetector):
    ...
    def __init__(self, syn_rate_thresh: float = 50.0, syn_ack_ratio_max: float = 0.2, udp_rate_thresh: float = 100.0):
    ...
    def analyze_flow(self, flow_features: Dict[str, Any]) -> Optional[DetectionResult]:
        ...
        if protocol == "UDP" and pkts_per_sec >= self.udp_rate_thresh:
